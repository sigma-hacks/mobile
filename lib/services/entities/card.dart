...
class Card with _$Card {
    ...
    factory Card.fromRegister(Register register, Map<String,dynamic> names, List<Tariff> tariffs) {
      try {
        final tariff = tariffs.firstWhere((e) => register.tariffId == e.id, orElse: 
          () => const Tariff(name: "Default", amount: 100, id: 0));
        return Card(hash: register.hash, 
        ...
        return Card(hash: 1, birthdate: 1, cardNumber: 1, expirationDate: 1, tariff: Tariff(name: "Default", amount: 100, id: 0), name: "1234");
      }
    }
